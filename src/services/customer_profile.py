...
DEFAULT_ADDRESS_SUFFIX = "Plan subscription"
...
def get_customer_profile(source) -> Dict[str, str]:
    """Build a customer profile for plan subscription payments."""
    ...
    email = user_email or f"customer_{getattr(source, 'id', 'unknown')}@example.com"
